    ...
    def get_strategy_config_dict_vh() -> dict:
        return {
            ...
            StrategyType.EMA_8_CROSS_EMA_30_FILTER_EMA_100: StrategyConfigModel(
                ...
                name="5. EMA 8 X EMA 30 Filter EMA 100",
                length=0,
                miv_value=0,
                max_value=0,
            ),
            ...
            StrategyType.CCI_14_BASED_TREND_100: StrategyConfigModel(
                ...
                name="6. Check Trends and CCI(14) cross +/- 100",
                length=14,
                miv_value=-100,
                max_value=100,
            ),
            StrategyType.CCI_20_100_TREND_UP_LEVEL: StrategyConfigModel(
                ...
                name="7. Check Trend Up Level and CCI(20) +/- 100",
                length=20,
                miv_value=-100,
                max_value=100,
            ),
            StrategyType.CCI_14_100_TRENDS_DIRECTION: StrategyConfigModel(
                ...
                name="8. Quick positions for Trends and CCI(14) +/- 100",
                length=14,
                miv_value=-100,
                max_value=100,
            ),
            StrategyType.EMA_8_CROSS_EMA_30_FILTER_CCI_14: StrategyConfigModel(
                ...
                name="9. EMA 8 crosses EMA 30 with filter CCI(14) +/- 100",
                length=14,
                miv_value=-100,
                max_value=100,
            ),
            StrategyType.EMA_8_CROSS_EMA_30_FILTER_CCI_20: StrategyConfigModel(
                ...
                name="10. EMA 8 crosses EMA 30 with filter EMA 100 and CCI(20) +/- 100",
                length=20,
                miv_value=-100,
                max_value=100,
            ),
            ...
            StrategyType.EMA_30_CROSS_EMA_100: StrategyConfigModel(
                strategy=StrategyType.EMA_30_CROSS_EMA_100,
                name="12. EMA 30 crosses EMA 100",
                length=20,
                miv_value=-100,
                max_value=100,
            ),
