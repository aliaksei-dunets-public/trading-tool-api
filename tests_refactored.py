...
#         query = {"chatId": 689916629,
#                  "symbol": "BTC/USD",
#                  "interval": Const.TA_INTERVAL_5M,
#                  "strategies": [Const.TA_STRATEGY_CCI_14_TREND_100, Const.TA_STRATEGY_CCI_20_TREND_100],
...
#         self.assertEqual(result_get_one["chatId"], 689916629)
#         self.assertEqual(result_get_one["symbol"], "BTC/USD")
#         self.assertEqual(result_get_one["interval"], Const.TA_INTERVAL_5M)
#         self.assertEqual(result_get_one["strategies"], [
#             Const.TA_STRATEGY_CCI_14_TREND_100, Const.TA_STRATEGY_CCI_20_TREND_100])
#         self.assertEqual(result_get_one["signals"], [Const.DEBUG_SIGNAL])
#         self.assertEqual(result_get_one["comments"], "Test comments")

#         query_update = {"strategies": [Const.TA_STRATEGY_CCI_14_TREND_100],
#                         "signals": [],
...
#         self.assertEqual(result_get_one["strategies"], [
#             Const.TA_STRATEGY_CCI_14_TREND_100])
#         self.assertEqual(result_get_one["signals"], [])
#         self.assertEqual(
#             result_get_one["comments"], "Test comments updated")

#         query = {"interval": Const.TA_INTERVAL_5M}
...
#         self.assertEqual(result_get_one["_id"], ObjectId(self.job_id))
#         self.assertEqual(result_get_one["jobType"], job_type)
#         self.assertEqual(result_get_one["interval"], interval)
#         self.assertEqual(result_get_one["isActive"], is_active)

#         result = self.mongo_jobs.deactivate_job(self.job_id)
#         self.assertTrue(result)

#         result_get_one = self.mongo_jobs.get_one(self.job_id)
#         self.assertEqual(result_get_one["isActive"], False)

#         result = self.mongo_jobs.activate_job(self.job_id)
#         self.assertTrue(result)

#         result_get_one = self.mongo_jobs.get_one(self.job_id)
#         self.assertEqual(result_get_one["isActive"], True)
...
#     def test_get_alerts_by_interval(self):
...
#     def test_get_orders_by_interval(self):
#         interval = Const.TA_INTERVAL_4H
